...
<link rel="stylesheet" type="text/css" href="{{ asset('/assets/app-assets/css/core/colors/palette-tooltip.css') }}">
<!-- END: Page CSS-->
...
{{-- Third Party --}}
<link rel="stylesheet" href="{{ url('https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css') }}">